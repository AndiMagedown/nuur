     ...
     <!-- TPQ -->
      ...
      <section class="pendidikan">
        ...
        <div class="row">
          ...
          <div class="pendidikan-col"> 
            <a href="pengurus.php"><h3>PENGAJAR</h3></a>
            <a href="pengurus.php"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit dolores doloribus nisi ea aut, tenetur id ex fugit quidem nesciunt minima! Quas ut obcaecati tempore!</p></a>
          </div>
        </div>
        </div>
